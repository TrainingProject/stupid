...
extern void arp_rcv(struct sk_buff *skb);
extern void arp_send(struct sk_buff *skb);
extern struct arptab arp_table[ARP_TABLE_SIZE];
...
extern void arp_request(__be32 daddr);
extern int arp_hash(__u32 x);
#endif
